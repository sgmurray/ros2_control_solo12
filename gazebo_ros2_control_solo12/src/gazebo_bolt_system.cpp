...
#include "gazebo_ros2_control_solo12/system_interface_bolt.hpp"
  ...
  gazebo::physics::ModelPtr parent_model)
{
  ...
  this->dataPtr->joint_kp_cmd_[6]=0.2255;
  this->dataPtr->joint_kd_cmd_[6]=0.01;

  this->dataPtr->joint_kp_cmd_[7]=0.2255;
  this->dataPtr->joint_kd_cmd_[7]=0.01;

  this->dataPtr->joint_kp_cmd_[8]=0.2255;
  this->dataPtr->joint_kd_cmd_[8]=0.01;

  this->dataPtr->joint_kp_cmd_[9]=0.2255;
  this->dataPtr->joint_kd_cmd_[9]=0.01;

  this->dataPtr->joint_kp_cmd_[10]=0.2255;
  this->dataPtr->joint_kd_cmd_[10]=0.01;

  this->dataPtr->joint_kp_cmd_[11]=0.2255;
  this->dataPtr->joint_kd_cmd_[11]=0.01;
